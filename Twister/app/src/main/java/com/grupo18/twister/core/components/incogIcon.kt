...
public val Incognito: ImageVector
    get() {
        if (_Incognito != null) {
            return _Incognito!!
        }
        _Incognito = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.25f, 0.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.274f, -0.224f)
                curveToRelative(0.9f, 0.092f, 1.91f, 0.143f, 2.975f, 0.143f)
                arcToRelative(30f, 30f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.975f, -0.143f)
                arcToRelative(0.25f, 0.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.05f, 0.498f)
                curveToRelative(-0.918f, 0.093f, -1.944f, 0.145f, -3.025f, 0.145f)
                reflectiveCurveToRelative(-2.107f, -0.052f, -3.025f, -0.145f)
                arcToRelative(0.25f, 0.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.224f, -0.274f)
                moveTo(3.5f, 10f)
                ...
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.488f, 1.312f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.024f, 0f)
                ...
                arcToRelative(2.5f, 2.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.58f, 0f)
                lineToRelative(-0.21f, 0.07f)
                verticalLineToRelative(0.14f)
                arcToRelative(2.5f, 2.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -5f, 0f)
                close()
